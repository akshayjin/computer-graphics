            ...
            for (int iterator = 0; iterator < this->TotalFaces; iterator++)
            {
                fgets(buffer,300,file);
                    ...
                    if (buffer[0] == '3')
                    {
                        ...
                        if(texture_fun==0)
                        {
                            Faces_TextureUV[texture_index] = Faces_Triangles[triangle_index+2];
                            Faces_TextureUV[texture_index+1] =(atan2((Faces_Triangles[triangle_index+1]),(Faces_Triangles[triangle_index]))+PI)/(2*PI);
                            Faces_TextureUV[texture_index+2] = Faces_Triangles[triangle_index+5];
                            Faces_TextureUV[texture_index+3] =(atan2((Faces_Triangles[triangle_index+4]),(Faces_Triangles[triangle_index+3]))+PI)/(2*PI);
                            Faces_TextureUV[texture_index+4] = Faces_Triangles[triangle_index+8];
                            Faces_TextureUV[texture_index+5] =(atan2((Faces_Triangles[triangle_index+7] ),(Faces_Triangles[triangle_index+6]))+PI)/(2*PI);
                        }

                        else
                        {
                            Faces_TextureUV[texture_index] = 0.5 + atan2f(Faces_Triangles[triangle_index+2]+centerZ,Faces_Triangles[triangle_index]+centerX)/(2*PI);
                            Faces_TextureUV[texture_index+1] = 0.5 - asin(Faces_Triangles[triangle_index+1]+centerY)/PI;
                            Faces_TextureUV[texture_index+2] = 0.5 + atan2f(Faces_Triangles[triangle_index+5]+centerZ,Faces_Triangles[triangle_index+3]+centerX)/(2*PI);
                            Faces_TextureUV[texture_index+3] = 0.5 - asin(Faces_Triangles[triangle_index+4]+centerY)/PI;
                            Faces_TextureUV[texture_index+4] = 0.5 + atan2f(Faces_Triangles[triangle_index+8]+centerZ,Faces_Triangles[triangle_index+6]+centerX)/(2*PI);
                            Faces_TextureUV[texture_index+5] = 0.5 - asin(Faces_Triangles[triangle_index+7]+centerY)/PI;
                        }
                        texture_index += 6;
                        normal_index += 9;
                        triangle_index += 9;
