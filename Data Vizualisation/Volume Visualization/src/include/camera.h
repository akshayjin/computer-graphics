...
public:
	...
	void Print (void);
	void init (GLfloat vdX,GLfloat vdY,GLfloat vdZ,GLfloat rvX,GLfloat rvY,GLfloat rvZ,GLfloat uvX,GLfloat uvY,GLfloat uvZ,GLfloat pX,GLfloat pY,GLfloat pZ,GLfloat rX,GLfloat rY,GLfloat rZ);
